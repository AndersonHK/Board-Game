...
- This session is assigned `GROUP-CREATURE-03` only. Do not generate images for any other task group. When staging alternates, use `assets/card-art/incoming/GROUP-CREATURE-03/`.
